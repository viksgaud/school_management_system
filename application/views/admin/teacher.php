...
<body>
                        ...
                        <ul class="flex-column navbar-nav w-100 justify-content-between">
                            ...
                            <li class="nav-item">
                                <a class="nav-link pl-0" href="<?php echo base_url(); ?>admin/class_cl"><i
                                        class="fas fa-chalkboard-teacher"></i> <span class="">Manage Class</span></a>
                            </li>
                            <li class="nav-item">
    ...
    <div class="container">
        ...
        <h2 class="text-center" style="margin-top: 10px;">Teacher</a></h2>
        <br>
        <br>
                    ...
                    <div class="modal-body px-5">
                        <form id="myForm" method="post" action="" class="form-horizontal">
                            ...
                            <div class="form-group" id="">
                                ...
                                <select class="form-control" id="find_class" name="subName" required>
        ...
        <div class="text-center">
            <button type="button" id="add_button" class="btn btn-info btn-lg add_button" data-toggle="modal">Add
                Teacher</button>
        </div>
        ...
        $(document).ready(function() {
            ...
            $('#add_button').click(function() {
                ...
                $('#myModal').modal('show');
                $('#myModal').find('.modal-title').text("Add Teacher");
                $('#myForm').attr('action',
                    '<?php echo base_url(); ?>admin/Teacher_cl/insertData');

                $.ajax({
                    url: '<?php echo base_url(); ?>admin/Teacher_cl/showSubject',
                    type: 'ajax',
                    asynk: false,
                    dataType: 'json',
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.success) {
                                ...
                                $('.alert-success').html('Teacher ' + type +
                                        ' Successfully!!')
                                    .fadeIn()
            ...
            function showAllData() {
                ...
                $.ajax({
                    url: '<?php echo base_url(); ?>admin/Teacher_cl/showData',
                    type: "ajax",
                    asynk: false,
                    dataType: 'json',
                    success: function(response) {
            ...
            $('#showData').on('click', '.edit', function() {
                ...
                $('#myForm').attr('action',
                    '<?php echo base_url(); ?>admin/Teacher_cl/updateData');

                $.ajax({
                    url: '<?php echo base_url(); ?>admin/Teacher_cl/editData',
                    type: 'ajax',
                    method: 'get',
                    data: {
                        id: id
            ...
            $('#showData').on('click', '.delete', function() {
                ...
                $('#btnDelete').unbind().click(function() {
                    $.ajax({
                        url: '<?php echo base_url(); ?>admin/Teacher_cl/deleteData',
                        type: 'ajax',
                        method: 'get',
                        data: {
                            id: id
