        ...
        <div class="row wrapper min-vh-100 flex-column flex-sm-row">
            ...
            <main class="col bg-faded py-3">
                <div class="container">
                    ...
                    <h2 class="text-center" style="margin-top: 10px;">Subject</a></h2>
                    <br>
                    <br>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="myForm" method="post" action="" class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            <label for="formGroupExampleInput">Passing Marks</label>
                                            <input type="text" name="pm" class="form-control" id="name"
                                                placeholder="Please enter name" required />
                                        </div>
                                        <div class="form-group">
                                            <label for="formGroupExampleInput">Out of Marks</label>
                                            <input type="text" name="om" class="form-control" id="name"
                                                placeholder="Please enter name" required />
                                        </div>
            ...
            $(document).ready(function() {
                ...
                $('#add_button').click(function() {
                    ...
                    $('#myModal').modal('show');
                    $('#myModal').find('.modal-title').text("Add Subject");
                    $('#myForm').attr('action',
                        '<?php echo base_url(); ?>admin/Subject_cl/insertData');
                ...
                $('#btnSave').click(function() {
                    ...
                    var passM = $('input[name=pm]');
                    var outM = $('input[name=om]');

                    var result = '';

                    if (name.val() == '' || passM.val() == '' || outM.val() == '') {
                        result = 0;
                    } else {
                        result = 1;
                    }
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                if (response.success) {
                                    ...
                                    $('.alert-success').html('Subject ' + type +
                                            ' Successfully!!')
                                        .fadeIn()
                ...
                function showAllData() {
                    ...
                    $.ajax({
                        url: '<?php echo base_url(); ?>admin/Subject_cl/showData',
                        type: "ajax",
                        asynk: false,
                        dataType: 'json',
                        success: function(response) {
                ...
                $('#showData').on('click', '.edit', function() {
                    ...
                    $('#myModal').modal('show');
                    $('#myModal').find('.modal-title').text("Edit Subject");
                    $('#myForm').attr('action',
                        '<?php echo base_url(); ?>admin/Subject_cl/updateData');

                    $.ajax({
                        url: '<?php echo base_url(); ?>admin/Subject_cl/editData',
                        type: 'ajax',
                        method: 'get',
                        data: {
                            id: id
                        ...
                        success: function(data) {
                            ...
                            $('input[name=name]').val(data.subjectName);
                            $('input[name=pm]').val(data.passingMarks);
                            $('input[name=om]').val(data.outofMarks);
                ...
                $('#showData').on('click', '.delete', function() {
                    ...
                    $('#btnDelete').unbind().click(function() {
                        $.ajax({
                            url: '<?php echo base_url(); ?>admin/Subject_cl/deleteData',
                            type: 'ajax',
                            method: 'get',
                            data: {
                                id: id
